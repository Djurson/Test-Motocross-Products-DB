...
import { ComboboxDemo } from "@/components/dropdownupload";
...
export default function Page() {
  ...
  async function ButtonClickUpload() {
    ...
    await UploadFileToBackend(fileToUpload);
  }
    ...
    <div className="flex flex-col items-center justify-center w-full gap-8 py-6">
      <Card className="w-full max-w-6xl">
        <CardHeader>
          ...
          <CardDescription>Ladda upp produkter och koppla dem till kategorierer</CardDescription>
        </CardHeader>
        <CardContent>
          <>
            {!fileToUpload ? (
              ...
              <div className="w-full h-full flex flex-col items-center justify-start gap-4">
                ...
                <div className="flex justify-center items-center gap-8 w-full">
                  <div className="grid grid-cols-1 grid-rows-2 w-xs">
                    ...
                    <Input placeholder="Exempelvis fjädring, kolvar etc..." />
                  </div>
                  <div className="grid grid-cols-1 grid-rows-2 w-fit">
                    <Label>Förkortning</Label>
                    <Input placeholder="KT, DFD, DFZE, TA ..." />
                  </div>
                </div>
